...
export const Navbar = ({inverted}:{inverted:boolean}) => {
	return (
		<div className={`navbar fixed z-30 ${inverted ? "bg-base-100/10" :"bg-mocha-700 border-b-2 border-mocha-700"} `}>
			<div className="navbar-start">
				<div className="dropdown">
					...
					<ul
						...
						<li><a className="text-xl">Services</a>
							<ul className="p-2 text-xl">
								<li><Link to={"/makelaardij"}>Makelaardij</Link></li>
								<li><Link to={"/mediation"}>Mediation</Link></li>
							</ul>
						</li>
						<li>
							<a>Huizen</a>
			...
			<div className="navbar-center hidden lg:flex">
				<ul className={`menu menu-horizontal px-1 text-md ${inverted ? 'text-white' : 'text-mocha-50'}`}>
					<li><Link to={'/makelaardij'}>Makelaardij</Link></li>
					<li><Link to={'/mediation'}>Mediation</Link></li>
					{/*<li>*/}
					{/*	<details>*/}
